package com.xiaomi.supercleanmaster.service;
        ...
        if (action != null) {
            if (action.equals(ACTION_CLEAN_AND_EXIT)) {
                setOnActionListener(new OnPeocessActionListener() {
                    ...
                    @Override
                    public void onCleanCompleted(Context context, long cacheSize) {
                        @SuppressLint({"StringFormatInvalid", "LocalSuppress"}) String msg = getString(R.string.cleaned, Formatter.formatShortFileSize(
